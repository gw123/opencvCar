...
//右前
#define FRONT_RIGHT_GO     FRONT_RIGHT_F_RESET;FRONT_RIGHT_B_SET 
#define FRONT_RIGHT_BACK   FRONT_RIGHT_F_SET;  FRONT_RIGHT_B_RESET
...
//右后
#define BEHIND_RIGHT_GO    BEHIND_RIGHT_F_RESET;BEHIND_RIGHT_B_SET 
#define BEHIND_RIGHT_BACK  BEHIND_RIGHT_F_SET;BEHIND_RIGHT_B_RESET
